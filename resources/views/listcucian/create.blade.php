...
initial-scale=1.0">
    ...
    <title>Tambah Data Cucian</title>
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <form action="{{ route('listcucian.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            
                            <div class="form-group">
                                <label class="font-weight-bold">Jenis Cucian</label>

                                <input type="text" class="form-control @error('jenis_cucian') is-invalid @enderror"
                                    name="jenis_cucian" placeholder="Jenis Cucian">

                                <!-- error message untuk jenis_cucian -->
                                @error('jenis_cucian')
